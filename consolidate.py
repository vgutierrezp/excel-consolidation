...
def consolidate_excels(source_folder, output_file):
        ...
        if file.endswith(".xlsx") and file != 'consolidated_file.xlsx':  # Ignorar el archivo consolidado anterior
            ...
            for sheet_name in xls.sheet_names:
                ...
                if 'Marca' in df.columns:
                    ...
                    # Verifica si el DataFrame no está vacío o contiene solo valores NA
                    if not df.empty and df.dropna(how='all').shape[1] > 0:
    ...
    if not all_data.empty:
        ...
        print("No se encontró información para consolidar.")
